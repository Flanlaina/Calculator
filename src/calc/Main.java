...
*/
	...
	public Main() {
        ...
        inText.setFont(new Font("Courier New", Font.PLAIN, 30));
        window.add(inText);
        ...
        btnMod = initBtn("mod", x[2], y[1], event -> {
            repaintFont();
        ...
        btnPoint = initBtn(".", x[1], y[5], event -> {
            repaintFont();
            if (addWrite) {
        ...
        btnPower.setFont(new Font("Tahoma", Font.PLAIN, 24));
